...
export default function Pricing() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 font-sans py-16 px-4">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-500 text-lg">Start free. Upgrade when your business needs more.</p>
        </div>
        ...
        <div className="grid grid-cols-4 gap-4">
          {plans.map((plan) => (
            <div
              key={plan.id}
              className={`relative bg-white rounded-2xl border-2 ${plan.color} p-6 flex flex-col ${plan.popular ? 'shadow-lg' : 'shadow-sm'}`}
            >
              {plan.popular && (
        ...
        <div className="mt-12 text-center space-y-2">
          ...
          <p className="text-sm text-gray-400">
            Questions?{' '}
            <a href="mailto:support@waautobot.com" className="text-green-600 hover:underline">
              Contact support
            </a>
          </p>
        </div>
